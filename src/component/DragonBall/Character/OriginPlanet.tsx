...
export const OriginPlanet: React.FC<OriginPlanetProps> = ({ character }) => {
  ...
  return (
    <div className="max-w-5xl mt-8 text-center bg-card text-card-foreground p-5 rounded-lg shadow-lg">
      ...
      <div className="flex flex-col md:flex-row items-center justify-center">
        ...
        <div className="md:ml-8 text-left">
          ...
          <p className="text-md text-gray-700 dark:text-gray-300">{character.originPlanet.description}</p>
        </div>
      </div>
    </div>
  );
